 ...
 * the License.
 */
package com.xinqi.kisso.common.captcha.filter.predefined;

import java.awt.image.BufferedImageOp;
import java.util.ArrayList;
import java.util.List;

import com.xinqi.kisso.common.captcha.filter.AbstractFilterFactory;
import com.xinqi.kisso.common.captcha.filter.library.DoubleRippleImageOp;
