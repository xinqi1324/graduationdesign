 ...
 */
package com.xinqi.framework.datasource;
 ...
 *
 * <!--数据源切面注入spring-->
 * <bean id="dsDataSourceAop" class="com.xinqi.framework.aop.DataSourceAop"/>
 *
 * <!--多数据源-->
 * <bean id="dynamicDataSource" class="com.xinqi.framework.datasource.DynamicDataSource">
